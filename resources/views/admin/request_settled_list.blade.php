        ...
        <table class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Settled Date & Time</th>
                    <th class="text-center">Status</th>
                    <th class="text-center">Action</th>
                </tr>
            </thead>
            <tbody>
                @if(isset($settled_helps) && count($settled_helps) > 0)
                    @foreach($settled_helps as $help)
                        <tr>
                ...
                @else
                    <tr>
                        <td colspan="7" class="text-center">No Settled Request Help Recorded.</td>
                    </tr>
                @endif
            </tbody>
        </table>
